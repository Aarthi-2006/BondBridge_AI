...
// =========================================================
// LOAD VERIFIED AI REPORTS FOR STUDENT
// =========================================================
...
Future<void> _loadVerifiedReports() async {
 ...
 void _onClassChanged(String? value) {
  ...
  Future<void> _onSectionChanged(String? value) async {
...
const SizedBox(height: 25),
          ...
          Text(
            generatedReport!["strengths"]?.toString() ??
                "No information available.",
            style: const TextStyle(
              fontSize: 15,
            ),
          ...
          Text(
            generatedReport!["improvement_areas"]?.toString() ??
                "No information available.",
            style: const TextStyle(
              fontSize: 15,
            ),
          ...
          Text(
            generatedReport!["ai_suggestions"]?.toString() ??
                "No information available.",
            style: const TextStyle(
              fontSize: 15,
            ),
...
if (reportApproved)
  ...
  SizedBox(
    ...
    height: 50,
    child: ElevatedButton.icon(
      onPressed: isApprovingReport
          ? null
          : _approveAIReport,

      icon: isApprovingReport
          ? const SizedBox(
              width: 20,
              height: 20,
              child: CircularProgressIndicator(
